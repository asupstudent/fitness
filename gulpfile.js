...
import del from 'del';
import {validateW3C, lintBem} from './gulp/validateMarkup.mjs';
...
const runValidateW3C = () => validateW3C();
const runLintBem = () => lintBem();

export { createWebp as webp, build, start, dev, runValidateW3C, runLintBem};
